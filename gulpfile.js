...
gulp.task('compile-js', function() {
    return gulp.src([DEV_DEVJS_DIR+'scrollIt.js',DEV_DEVJS_DIR+'script.js',DEV_DEVJS_DIR+'detectmobilebrowser.js',DEV_DEVJS_DIR+'jquery.address-1.6.min.js',DEV_DEVJS_DIR+Project.prefix+'.js'])
        //.pipe(uglify())
